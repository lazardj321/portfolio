...
/*-----------------------------------------------------------------------------
  LOADING DATA
-----------------------------------------------------------------------------*/
minixhr('https://api.github.com/users/lazardj321', responseHandler1)
...
function footerComponent ({ data = {}, theme = {} } = {}) {
  ...
  function template () {
    ...
    <div class="${css.container}">
      <a href="https://github.com/lazardj321">
        <i class="${css.icon} fa fa-github" aria-hidden="true"></i>
      </a>
        <a href="mailto:lazardj321@gmail.com ">
